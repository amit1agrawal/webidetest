...
sap.ui.define([
		...
		return BaseController.extend("com.spc.fiori.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					//this._oListFilterState.aSearch = [new Filter("Vssl", FilterOperator.Contains, sQuery)];
					this._oListFilterState.aSearch = [new Filter("BolSerial", FilterOperator.Contains, sQuery)];
				} else {
		...
		/*	onSearch :function(oEvent){
			...
			if (searchString && searchString.length > 0) {
				...
				filters = [new sap.ui.model.Filter("LocationNumber", sap.ui.model.FilterOperator.Contains, searchString)];
			}
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.spc.fiori.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Grt", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Grt", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("BolSerial");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("BolSerial")
				}, bReplace);
			},
			
			showAddNew: function(){
				var bReplace = !Device.system.phone;
				this.getRouter().navTo("addnew", null, bReplace);
